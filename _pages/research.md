...
<p>This research work proposes a scene graph enhanced deep neuron network for localization under visual uncertainties using Pytorch. The proposed network is provided to have a better performance in visual navigation tasks under object dynamics compared to that using CNN benchmark architectures.</p>
